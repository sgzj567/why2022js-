...
<template>
  <div class="app">
    ...
    <!-- transition本质是在加class -->
    <!-- in-out表示先进入在离开  out-in表示先离开后进入 -->
    <!-- mode属性 -->
    <transition name="why" mode="out-out">
      <h2 v-if="isShow" class="h">
